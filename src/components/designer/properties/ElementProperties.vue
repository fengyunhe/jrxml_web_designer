      ...
      <n-tabs type="segment">
        ...
        <n-tab-pane name="basic" :tab="t('properties.basicProperties')" >
          ...
          <template v-else-if="currentElement && currentElement.type === 'textField'">
            ...
            <div class="form-group">
              <label>超链接类型</label>
              <select v-if="currentElement" v-model="currentElement.hyperlinkType">
            ...
            <div class="form-group">
              <label>书签层级</label>
              <input v-if="currentElement" v-model.number="currentElement.bookmarkLevel" type="number" min="0" />
            </div>
